...
export default function Home() {
  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-20 pb-20 gap-16 text-yellow-400 bg-blue-600 relative">
      ...
      <form className="md:max-w-1/2 xl:max-w-1/4 w-full">
        ...
        <button type="submit" className="bg-yellow-500 w-full py-3 px-1.5 rounded-full font-bold capitalize text-blue-600 text-xl sm:text-2xl cursor-pointer transition-all hover:bg-yellow-600 mt-10">Add</button>
      </form>
